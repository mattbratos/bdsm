    ...
    <div className="flex flex-col min-h-screen bg-background relative">
      ...
      <main className="flex-1 flex flex-col max-w-3xl mx-auto w-full p-4 grid-pattern">
        ...
        {/* <div className="mt-6 text-sm text-muted-foreground font-pixel-body">
          <p>
            Note: This is a placeholder chatbot. In a real implementation, this
            would be connected to an AI service using the AI SDK to provide
            accurate project estimates and information.
          </p>
        </div> */}
      </main>
    </div>
